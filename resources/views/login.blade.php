...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    @if($providers['use_dafault_login'])
    ...
    @endif
    @if(count($providers['login_providers']) > 0)
        <style>
          @foreach($providers['login_providers'] as $k => $v)
            .{{ $v['btn_name'] }}{
        ...
        <div class="social-auth-links text-center">
            ...
            @endif
            @foreach($providers['login_providers'] as $k => $v)
            <a href="{{ admin_base_path("auth/login/$k") }}" class="btn btn-block btn-social btn-flat {{ $v['btn_name'] }}">
                <i class="fa {{ $v['font_owesome'] }}"></i> Sign in using {{ $v['display_name'] }}</a>
            @endforeach
        </div>
    @endif
  </div>
